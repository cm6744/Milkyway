...
import cm.glbackends.gdx.g3d.CameraGdx;
import cm.glbackends.gdx.g3d.ModelGdx;
import cm.glbackends.gdx.g3d.ModelInsGdx;
...
public class GLGdx3D implements GL3D
{
    ...
    public void render(Model3DObject id, double x, double y, double z)
    {
        ...
        if(camera.frustum.sphereInFrustum(bbCenter, bbRad)) {
            ...
            attr.opacity = (float) (distancedFog(dist) * gl.curState().alpha);
